...
- [ ] 2.1 Создать страницу `/products/index.vue` (каталог)
- [ ] 2.2 Добавить поиск по названию товара
- [ ] 2.3 Добавить фильтр по категориям (sidebar)
- [ ] 2.4 Добавить сортировку (цена, популярность, новизна)
- [ ] 2.5 Добавить пагинацию
- [ ] 2.6 Добавить фильтр по цене (min-max)
- [ ] 2.7 Показать количество товаров в категории
...
- `frontend/app/composables/useProducts.ts` (опционально)
...
- [ ] 3.1 Создать страницу `/checkout.vue`
- [ ] 3.2 Добавить форму адреса доставки
- [ ] 3.3 Добавить выбор способа оплаты
- [ ] 3.4 Добавить поле для промокода
- [ ] 3.5 Показать итоговую сумму с учетом скидки
- [ ] 3.6 Добавить подтверждение заказа
- [ ] 3.7 Редирект на страницу успешного заказа
- [ ] 3.8 Очистить корзину после оформления

**Файлы для создания:**

- `frontend/app/pages/checkout.vue`
- `frontend/app/pages/order-success.vue`
- `frontend/app/components/CheckoutForm.vue`
- `frontend/app/components/PromoCodeInput.vue`
- `frontend/app/stores/order.ts`
- `frontend/app/composables/usePromoCode.ts` (опционально)
...
- [ ] 4.1 Добавить поле промокода в корзину (`/cart`)
- [ ] 4.2 Валидация промокода в реальном времени
- [ ] 4.3 Показать примененную скидку
- [ ] 4.4 Обновить итоговую сумму с учетом скидки
- [ ] 4.5 Сохранить промокод для checkout
...
- [ ] 5.1 Создать страницу `/orders/index.vue`
- [ ] 5.2 Показать список всех заказов пользователя
- [ ] 5.3 Отобразить статус каждого заказа
- [ ] 5.4 Создать страницу `/orders/[id].vue` для деталей
- [ ] 5.5 Показать товары в заказе
- [ ] 5.6 Добавить кнопку "Повторить заказ"
- [ ] 5.7 Показать историю статусов заказа
...
- `frontend/app/stores/order.ts` (если еще не создан)
