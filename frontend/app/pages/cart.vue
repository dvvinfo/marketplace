<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
        🛒 Корзина
      </h1>
      ...
      <div v-else-if="cartStore.items.length === 0" class="text-center py-12 bg-white rounded-2xl shadow-lg">
        <UIcon name="i-heroicons-shopping-cart" class="w-24 h-24 mx-auto text-gray-400 mb-4" />
        <p class="text-gray-600 mb-6 text-lg">Ваша корзина пуста</p>
        <UButton 
          to="/"
          size="lg"
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div>
          <UCard class="sticky top-4">
            <template #header>
              <h2 class="text-2xl font-bold text-gray-800">Итого</h2>
            </template>
